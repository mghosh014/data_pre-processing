...
// ==============================================================
#ifndef __float_subtractiondEe__HH__
#define __float_subtractiondEe__HH__
...
template<
    ...
    int din0_WIDTH,
    int dout_WIDTH>
SC_MODULE(float_subtractiondEe) {
    ...
    SC_CTOR(float_subtractiondEe):  ACMP_sitofp_U ("ACMP_sitofp_U") {
