...
reg   [0:0] tmp_1_reg_109_pp0_iter16_reg;
...
reg   [0:0] tmp_1_reg_109_pp0_iter13_reg;
reg   [0:0] tmp_1_reg_109_pp0_iter14_reg;
reg   [0:0] tmp_1_reg_109_pp0_iter15_reg;
...
reg    ap_predicate_tran2to20_state2;
...
double_subtractiobkb #(
    .ID( 1 ),
    .NUM_STAGE( 5 ),
    .din0_WIDTH( 64 ),
    .din1_WIDTH( 64 ),
    .dout_WIDTH( 64 ))
double_subtractiobkb_U1(
    .clk(ap_clk),
    .reset(ap_rst),
    .din0(d_reg_133),
    .din1(e_reg_138),
...
double_subtractiocud #(
    .ID( 1 ),
    .NUM_STAGE( 5 ),
    .din0_WIDTH( 64 ),
    .din1_WIDTH( 64 ),
    .dout_WIDTH( 64 ))
double_subtractiocud_U2(
    .clk(ap_clk),
    .reset(ap_rst),
    .din0(tmp_5_reg_143),
    .din1(64'd4549554898322029055),
    .ce(grp_fu_83_ce),
    .dout(grp_fu_83_p2)
);

double_subtractiodEe #(
    .ID( 1 ),
    .NUM_STAGE( 5 ),
    .din0_WIDTH( 32 ),
    .dout_WIDTH( 64 ))
double_subtractiodEe_U3(
    .clk(ap_clk),
    .reset(ap_rst),
    .din0(grp_fu_88_p0),
    .ce(grp_fu_88_ce),
...
double_subtractioeOg #(
    .ID( 1 ),
    .NUM_STAGE( 2 ),
    .din0_WIDTH( 64 ),
    .dout_WIDTH( 16 ))
double_subtractioeOg_U5(
    .clk(ap_clk),
    .reset(ap_rst),
    .din0(f_reg_148),
    .ce(grp_fu_94_ce),
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (tmp_1_reg_109_pp0_iter4_reg == 1'd1))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (tmp_1_reg_109_pp0_iter14_reg == 1'd1))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (ap_predicate_op34_read_state2 == 1'b1))) begin
        tmp_4_reg_118 <= b_V_dout;
    end
end

always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (tmp_1_reg_109_pp0_iter9_reg == 1'd1))) begin
...
always @ (*) begin
    if ((ap_predicate_tran2to20_state2 == 1'b1)) begin
...
always @ (*) begin
    if (((tmp_1_reg_109_pp0_iter16_reg == 1'd1) & (1'b0 == ap_block_pp0_stage0) & (ap_enable_reg_pp0_iter17 == 1'b1))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (tmp_1_reg_109_pp0_iter16_reg == 1'd1) & (ap_enable_reg_pp0_iter17 == 1'b1))) begin
        c_V_write = 1'b1;
    end else begin
        c_V_write = 1'b0;
    end
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_pp0_stage0 : begin
            if ((~((ap_enable_reg_pp0_iter0 == 1'b1) & (ap_predicate_tran2to20_state2 == 1'b1) & (ap_enable_reg_pp0_iter1 == 1'b0) & (1'b0 == ap_block_pp0_stage0_subdone)) & ~((ap_enable_reg_pp0_iter16 == 1'b0) & (ap_enable_reg_pp0_iter17 == 1'b1) & (1'b0 == ap_block_pp0_stage0_subdone)))) begin
                ap_NS_fsm = ap_ST_fsm_pp0_stage0;
            end else if ((((ap_enable_reg_pp0_iter16 == 1'b0) & (ap_enable_reg_pp0_iter17 == 1'b1) & (1'b0 == ap_block_pp0_stage0_subdone)) | ((ap_enable_reg_pp0_iter0 == 1'b1) & (ap_predicate_tran2to20_state2 == 1'b1) & (ap_enable_reg_pp0_iter1 == 1'b0) & (1'b0 == ap_block_pp0_stage0_subdone)))) begin
...
always @ (*) begin
    ap_block_pp0_stage0_01001 = (((tmp_1_reg_109_pp0_iter16_reg == 1'd1) & (c_V_full_n == 1'b0) & (ap_enable_reg_pp0_iter17 == 1'b1)) | ((ap_enable_reg_pp0_iter0 == 1'b1) & (((b_V_empty_n == 1'b0) & (ap_predicate_op34_read_state2 == 1'b1)) | ((1'b0 == a_V_empty_n) & (ap_predicate_op33_read_state2 == 1'b1)))));
end

always @ (*) begin
    ap_block_pp0_stage0_11001 = (((tmp_1_reg_109_pp0_iter16_reg == 1'd1) & (c_V_full_n == 1'b0) & (ap_enable_reg_pp0_iter17 == 1'b1)) | ((ap_enable_reg_pp0_iter0 == 1'b1) & (((b_V_empty_n == 1'b0) & (ap_predicate_op34_read_state2 == 1'b1)) | ((1'b0 == a_V_empty_n) & (ap_predicate_op33_read_state2 == 1'b1)))));
end

always @ (*) begin
    ap_block_pp0_stage0_subdone = (((tmp_1_reg_109_pp0_iter16_reg == 1'd1) & (c_V_full_n == 1'b0) & (ap_enable_reg_pp0_iter17 == 1'b1)) | ((ap_enable_reg_pp0_iter0 == 1'b1) & (((b_V_empty_n == 1'b0) & (ap_predicate_op34_read_state2 == 1'b1)) | ((1'b0 == a_V_empty_n) & (ap_predicate_op33_read_state2 == 1'b1)))));
end
...
always @ (*) begin
    ap_block_state19_pp0_stage0_iter17 = ((tmp_1_reg_109_pp0_iter16_reg == 1'd1) & (c_V_full_n == 1'b0));
end

always @ (*) begin
    ap_block_state2_pp0_stage0_iter0 = (((b_V_empty_n == 1'b0) & (ap_predicate_op34_read_state2 == 1'b1)) | ((1'b0 == a_V_empty_n) & (ap_predicate_op33_read_state2 == 1'b1)));
end
...
always @ (*) begin
    ap_predicate_op34_read_state2 = ((tmp_1_nbreadreq_fu_52_p3 == 1'd1) & (tmp_nbreadreq_fu_44_p3 == 1'd1));
end

always @ (*) begin
    ap_predicate_tran2to20_state2 = ((tmp_1_nbreadreq_fu_52_p3 == 1'd0) | (tmp_nbreadreq_fu_44_p3 == 1'd0));
end
