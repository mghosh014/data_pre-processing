...
// ==============================================================
#ifndef __double_subtractiodEe__HH__
#define __double_subtractiodEe__HH__
...
template<
    ...
    int din0_WIDTH,
    int dout_WIDTH>
SC_MODULE(double_subtractiodEe) {
    ...
    SC_CTOR(double_subtractiodEe):  ACMP_sitodp_U ("ACMP_sitodp_U") {
