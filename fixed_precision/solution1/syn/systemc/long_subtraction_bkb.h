...
// ==============================================================
#ifndef __long_subtraction_bkb__HH__
#define __long_subtraction_bkb__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(long_subtraction_bkb) {
    ...
    SC_CTOR(long_subtraction_bkb):  ACMP_mul_us_U ("ACMP_mul_us_U") {
