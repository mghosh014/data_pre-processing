set moduleName long_subtraction
set isTopModule 1
...
set C_modelName {long_subtraction}
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.long_subtraction_bkb_U1", "Parent" : "0"}]}
...
set ArgLastReadFirstWriteLatency {
	long_subtraction {
		...
		c_V {Type O LastRead -1 FirstWrite 7}}}
