...
set id 5
set name double_subtractioeOg
set corename simcore_dptohp
set op dptohp
set stage_num 2
set max_latency -1
set registered_input 1
...
set out_width 16
if {${::AESL::PGuard_simmodel_gen}} {
if {[info proc ap_gen_simcore_dptohp] == "ap_gen_simcore_dptohp"} {
eval "ap_gen_simcore_dptohp { \
    id ${id} \
    name ${name} \
    corename ${corename} \
    op ${op} \
...
puts "@W \[IMPL-100\] Cannot find ap_gen_simcore_dptohp, check your AutoPilot builtin lib"
}
}
...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_a_V \
    op interface \
    ports { a_V_dout { I 16 vector } a_V_empty_n { I 1 bit } a_V_read { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_b_V \
    op interface \
    ports { b_V_dout { I 16 vector } b_V_empty_n { I 1 bit } b_V_read { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_c_V \
    op interface \
    ports { c_V_din { O 16 vector } c_V_full_n { I 1 bit } c_V_write { O 1 bit } } \
} "
}
