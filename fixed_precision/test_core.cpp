...
static short prj [MAX_PRJ][MAX_SLICE][DATA_SLICE];
...
int main()
{
	//define the streams for input and output
	...
	infile_3.open("long_output.bin", ios::out | ios::binary);
	    ...
	    long_subtraction(input_a, input_b, output_c);
