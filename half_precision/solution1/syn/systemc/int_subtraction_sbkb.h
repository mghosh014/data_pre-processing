...
// ==============================================================
#ifndef __int_subtraction_sbkb__HH__
#define __int_subtraction_sbkb__HH__
...
template<
    ...
    int din0_WIDTH,
    int dout_WIDTH>
SC_MODULE(int_subtraction_sbkb) {
    ...
    SC_CTOR(int_subtraction_sbkb):  ACMP_sitofp_U ("ACMP_sitofp_U") {
